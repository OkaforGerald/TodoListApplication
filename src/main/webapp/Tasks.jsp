...
<div class="container">
	...
	<tbody>
	<%
	int ListId=(int)request.getSession().getAttribute("ListID");
	TaskDAO td=new TaskDAO(DbConnection.getConnection());
		ArrayList<Task> userTask=td.getSpecificTasks(ListId);
	...
	<%}else{ %>
	<td><a href="MarkComplete?TaskID=<%=ts.getTaskID()%>" class="btn btn-primary">Mark as Complete</a></td>
	<%} %>
